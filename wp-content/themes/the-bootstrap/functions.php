...
function the_bootstrap_widgets_init() {
    ...
    register_sidebar( array(
        'name'			=>	__( 'Sagar Sidebar', 'the-bootstrap' ),
        'id'			=>	'sagar',
        'before_widget'	=>	'<aside id="%1$s" class="widget well %2$s">',
        'after_widget'	=>	'</aside>',
        'before_title'	=>	'<h2 class="widget-title">',
    ...
    register_sidebar( array(
        'name'			=>	__( 'Expert Areas ', 'the-bootstrap' ),
        'id'			=>	'experts',
        'before_widget'	=>	'',
        'after_widget'	=>	'',
        'before_title'	=>	'',
    ...
    register_sidebar( array(
		'name'			=>	__( 'Recent Blog', 'the-bootstrap' ),
		'description'	=>	__( 'We are showing the cently added blog here', 'the-bootstrap' ),
		'id'			=>	'recentblog',
		'before_widget'	=>	'',
		'after_widget'	=>	'=',
		'before_title'	=>	'',
    ...
    if( class_exists( 'kdMultipleFeaturedImages' ) ) {
        ...
        $args1 = array(
            'id' => 'right-side-image1',
            'post_type' => 'post',      // Set this to post or page
            'labels' => array(
                'name'      => 'Right Side Image 1',
                'set'       => 'Set Right Side Image 1',
                'remove'    => 'Remove Right Side Image 1',
                'use'       => 'Use as Right Side Image 1',
            )
        );
    ...
    if( class_exists( 'kdMultipleFeaturedImages' ) ) {
        ...
        $args2 = array(
            'id' => 'right-side-image2',
            'post_type' => 'post',      // Set this to post or page
            'labels' => array(
                'name'      => 'Right Side Image 2',
                'set'       => 'Set Right Side Image 2',
                'remove'    => 'Remove Right Side Image 2',
                'use'       => 'Use as Right Side Image 2',
            )
        );
    ...
    if( class_exists( 'kdMultipleFeaturedImages' ) ) {
        ...
        $args3 = array(
            'id' => 'right-side-image3',
            'post_type' => 'post',      // Set this to post or page
            'labels' => array(
                'name'      => 'Right Side Image 3',
                'set'       => 'Set Right Side Image 3',
                'remove'    => 'Remove Right Side Image 3',
                'use'       => 'Use as Right Side Image 3',
            )
        );
